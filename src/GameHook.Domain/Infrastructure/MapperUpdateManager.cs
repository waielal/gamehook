    ...
    public class MapperUpdateManager : IMapperUpdateManager
    {
        ...
        public async Task<bool> CheckForUpdates()
        {
            try
            {
                ...
                else if (CheckForMapperUpdatesMinutes == 0 || MapperData.LastCheckedDate.HasValue == false || MapperData.LastCheckedDate.HasValue && (DateTime.UtcNow - MapperData.LastCheckedDate.Value).Minutes > CheckForMapperUpdatesMinutes)
                {
