...
namespace GameHook.IntegrationTests
{
    ...
    public class PokemonFireRed : BaseTest
    {
        ...
        public async Task FireRed_Property_OK_DMA_B_GameTime()
        {
            ...
            mapper.AssertAreEqual("gameTime.hours", 0x0202460E, [0x00], 0);
            mapper.AssertAreEqual("gameTime.minutes", 0x02024610, [0x1B], 27);
            mapper.AssertAreEqual("gameTime.seconds", 0x02024611, [0x12], 18);
            mapper.AssertAreEqual("gameTime.frames", 0x02024612, [0x34], 52);
        }
        ...
        public async Task FireRed_Property_OK_PokemonPartyStructure_Index0()
        {
            ...
            mapper.AssertAreEqual("player.team.0.personalityValue", [0x68, 0x5A, 0x6F, 0xA9], 2842647144);
            mapper.AssertAreEqual("player.team.0.checksum", 0x1C, [0x95, 0x55], 21909);
            mapper.AssertAreEqual("player.team.0.nickname", 0x08, [0xC8, 0xBB, 0xC7, 0xBF, 0xC6, 0xBF, 0xCD, 0xCD, 0xFF, 0xFF], "NAMELESS");
            mapper.AssertAreEqual("player.team.0.expPoints", 0x24, [0x92, 0x07, 0x00, 0x00], 1938);
            mapper.AssertAreEqual("player.team.0.itemHeld", 0x22, [0x0F, 0x00], "Burn Heal");
            ...
            mapper.AssertAreEqual("player.team.0.ivs.specialAttack", 0x48, [0x9A, 0xDA, 0xB0, 0x3B], 27);
            mapper.AssertAreEqual("player.team.0.ivs.specialDefense", 0x48, [0x9A, 0xDA, 0xB0, 0x3B], 29);
            ...
            mapper.AssertAreEqual("player.team.0.evs.specialAttack", 0x3C, [0x01], 1);
            mapper.AssertAreEqual("player.team.0.evs.specialDefense", 0x3D, [0x00], 0);

            mapper.AssertAreEqual("player.team.1.species", 0x20, [0x00, 0x00], null);
            mapper.AssertAreEqual("player.team.1.personalityValue", [0x00, 0x00, 0x00, 0x00], 0);
        }
        [TestMethod]
        ...
        public async Task FireRed_Property_OK_Options_Index0()
        {
            ...
            mapper.AssertAreEqual("options.battleAnim", 0x020255B9, [0x00], false);
            mapper.AssertAreEqual("options.battleStyle", 0x020255B9, [0x00], false);
            mapper.AssertAreEqual("options.sound", 0x020255B9, [0x00], false);
            mapper.AssertAreEqual("options.buttonMode", 0x020255B7, [0x00], 0);
        }
        [TestMethod]
        ...
        public async Task FireRed_Property_OK_Player_Index0()
        {
            ...
            mapper.AssertAreEqual("player.badges.badge1", 0x0202651A, [0x01], true);
            mapper.AssertAreEqual("player.badges.badge2", 0x0202651A, [0x01], false);
            mapper.AssertAreEqual("player.badges.badge2", 0x0202651A, [0x01], false);
        ...
        public async Task FireRed_Property_OK_BattleStructure_Index0()
        {
            ...
            mapper.AssertAreEqual("battle.outcome", 0x02023E8A, [0x00], null);
            mapper.AssertAreEqual("battle.other.type.trainer", 0x02022B4C, [0x0C, 0x00, 0x00, 0x00], true);
            mapper.AssertAreEqual("battle.other.type.double", 0x02022B4C, [0x0C, 0x00, 0x00, 0x00], false);
            mapper.AssertAreEqual("battle.field.weather", 0x02023F1C, [0x00], null);
            mapper.AssertAreEqual("battle.field.weatherCount", 0x02023F48, [0x00], 0);
            ...
            // mapper.AssertAreEqual("battle.player.activePokemon.type1", 0x020240A5, [0x0A], "Fire");
            ...
            mapper.AssertAreEqual("battle.opponent.activePokemon.species", 0x02023C3C, [0x0D, 0x00], "Weedle");
        }
    }
}
