...
namespace GameHook.IntegrationTests
{
    ...
    public class PokemonRedBlueYellow : BaseTest
    {
        ...
        public async Task Yellow_Property_OK_PokemonPartyStructure()
        {
            ...
            mapper.AssertAreEqual("player.teamCount", 0xD162, [0x04], 4);
            ...
            mapper.AssertAreEqual("player.team.0.moves.0.ppUp", 0xD187, [0x45], 1);
            ...
            mapper.AssertAreEqual("player.team.1.moves.0.ppUp", 0xD1B3, [0x23], 0);
        ...
        public async Task Yellow_Property_OK_PlayerBagStructure()
        {
            ...
            mapper.AssertAreEqual("bag.itemCount", 0xD31C, [0x13], 19);
        ...
        public async Task Yellow_Property_OK_Audio()
        {
            ...
            mapper.AssertAreEqual("audio.currentSound", 0xC001, [0xC7], 199);
            mapper.AssertAreEqual("audio.overworldTrackCurrentMap", 0xD35A, [0xC7], "Cerulean City, Fuchsia City");
            mapper.AssertAreEqual("audio.volume.channel1", 0xC0DE, [0xB6], 182);
        }
        [TestMethod]
        public async Task Yellow_Property_OK_GameTime()
        {
            ...
            mapper.AssertAreEqual("gameTime.hours", 0xDA3F, [0x00, 0x07], 7);
            mapper.AssertAreEqual("gameTime.minutes", 0xDA41, [0x00, 0x28], 40);
            mapper.AssertAreEqual("gameTime.seconds", 0xDA43, [0x19], 25);
            mapper.AssertAreEqual("gameTime.frames", 0xDA44, [0x33], 51);
        }
        [TestMethod]
        public async Task Yellow_Property_OK_Options()
        {
            ...
            mapper.AssertAreEqual("options.textSpeed1", 0xD354, [0xC1], false);
            mapper.AssertAreEqual("options.soloChallenge", 0xD354, [0xC1], "Fast Text, No Animations, Battlestyle Set");
        }
        [TestMethod]
        public async Task Yellow_Property_OK_BattleStructure()
        {
            ...
            mapper.AssertAreEqual("battle.other.battleStart", 0xCCF5, [0x01], 1);
            mapper.AssertAreEqual("battle.player.activePokemon.nickname", 0xD008, [0x81, 0x84, 0x84, 0x85, 0x50, 0x81, 0x80, 0x8B, 0x8B, 0x50, 0x00], "BEEF");
            mapper.AssertAreEqual("battle.player.activePokemon.species", 0xD013, [0x3C], "Tauros");
            mapper.AssertAreEqual("battle.player.activePokemon.modifiers.special", 0xCD1D, [0x06], "-1");
            mapper.AssertAreEqual("battle.player.activePokemon.stats.special", 0xD02A, [0x00, 0x3B], 59);
            mapper.AssertAreEqual("battle.player.activePokemon.moves.3.move", 0xD01E, [0x59], "Earthquake");
            mapper.AssertAreEqual("battle.player.activePokemon.moves.3.pp", 0xD02F, [0x8B], 11);
            mapper.AssertAreEqual("battle.opponent.name", 0xD049, [0x8A, 0x8E, 0x86, 0x80, 0x50, 0x81, 0x8B, 0x80, 0x88, 0x8D, 0x84], "KOGA");
            mapper.AssertAreEqual("battle.opponent.class", 0xD030, [0x26], "KOGA");

            mapper.AssertAreEqual("battle.opponent.id", 0xD05C, [0x01], 1);
            mapper.AssertAreEqual("battle.opponent.totalPokemon", 0xD89B, [0x04], 4);
            mapper.AssertAreEqual("battle.opponent.activePokemon.partyPos", 0xCFE7, [0x03], 3);
            mapper.AssertAreEqual("battle.opponent.activePokemon.stats.hp", 0xCFE5, [0x00, 0x00], 0);
            mapper.AssertAreEqual("battle.opponent.activePokemon.moves.0.move", 0xCFEC, [0x8D], "Leech Life");
        }
        [TestMethod]
        public async Task Yellow_Property_OK_Events()
        {
            ...
            var mapper = await GameHookClient.GetMapperAsync();
            mapper.AssertAreEqual("events.beatChampion", 0xD866, [0x00], false);
            mapper.AssertAreEqual("events.trashCanPuzzle", 0xD772, [0xDF], true);
            mapper.AssertAreEqual("events.overworldFlags.countPlayTime", 0xD731, [0x01], true);
        }
        [TestMethod]
        public async Task Yellow_Property_OK_Overworld()
        {
            ...
            mapper.AssertAreEqual("overworld.encounters.common.2.level", 0xD88B, [0x16], 22);
            mapper.AssertAreEqual("overworld.encounters.common.2.species", 0xD88C, [0x0C], "Exeggcute");
            mapper.AssertAreEqual("overworld.encounterRate", 0xD886, [0x00], 0);
            mapper.AssertAreEqual("overworld.mapData.palette", 0xD35C, [0x00], 0);
        }
        [TestMethod]
        public async Task Yellow_Property_OK_Screen()
        {
            ...
            mapper.AssertAreEqual("screen.menu.currentItem", 0xCC26, [0x00], 0);
            mapper.AssertAreEqual("screen.tiles.column1.tile7", 0x9CCC, [0x1F], 31);
        }
        ...
        public async Task Red_Property_OK_PlayerBagStructure()
        {
            ...
            mapper.AssertAreEqual("bag.itemCount", 0xD31D, [0x10], 16);
        ...
        public async Task Red_Property_OK_Audio()
        {
            ...
            mapper.AssertAreEqual("audio.currentSound", 0xC002, [0x00], 0);
            mapper.AssertAreEqual("audio.overworldTrackCurrentMap", 0xD359, [0x8E], null);
            mapper.AssertAreEqual("audio.volume.channel1", 0xC0DF, [0xC7], 199);
        }
        [TestMethod]
        public async Task Red_Property_OK_GameTime()
        {
            ...
            mapper.AssertAreEqual("gameTime.hours", 0xDA40, [0x00, 0x04], 4);
            mapper.AssertAreEqual("gameTime.minutes", 0xDA42, [0x00, 0x2B], 43);
            mapper.AssertAreEqual("gameTime.seconds", 0xDA44, [0x20], 32);
            mapper.AssertAreEqual("gameTime.frames", 0xDA45, [0x0B], 11);
        }
        [TestMethod]
        public async Task Red_Property_OK_Options()
        {
            ...
            mapper.AssertAreEqual("options.textSpeed1", 0xD355, [0x41], false);
            mapper.AssertAreEqual("options.soloChallenge", 0xD355, [0x41], "Champion Fight");
        }
        [TestMethod]
        public async Task Red_Property_OK_BattleStructure()
        {
            ...
            mapper.AssertAreEqual("battle.lowHealthAlarm", 0xCCF6, [0x00], "Enabled");
            mapper.AssertAreEqual("battle.other.battleStart", 0xCCF5, [0x00], 0);
            mapper.AssertAreEqual("battle.player.activePokemon.nickname", 0xD009, [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], "");
            mapper.AssertAreEqual("battle.player.activePokemon.species", 0xD014, [0x00], null);
            mapper.AssertAreEqual("battle.player.activePokemon.modifiers.special", 0xCD1D, [0x00], null);
            mapper.AssertAreEqual("battle.player.activePokemon.stats.special", 0xD029, [0x00, 0x00], 0);
            mapper.AssertAreEqual("battle.player.activePokemon.moves.3.move", 0xD01F, [0x00], null);
            mapper.AssertAreEqual("battle.player.activePokemon.moves.3.pp", 0xD030, [0x00], 0);
            mapper.AssertAreEqual("battle.opponent.name", 0xD04A, [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], "");
            mapper.AssertAreEqual("battle.opponent.class", 0xD031, [0x00], null);

            mapper.AssertAreEqual("battle.opponent.id", 0xD05D, [0x00], 0);
            mapper.AssertAreEqual("battle.opponent.totalPokemon", 0xD89C, [0x05], 5);
            mapper.AssertAreEqual("battle.opponent.activePokemon.partyPos", 0xCFE8, [0x00], 0);
            mapper.AssertAreEqual("battle.opponent.activePokemon.stats.hp", 0xCFE6, [0x00, 0x00], 0);
            mapper.AssertAreEqual("battle.opponent.activePokemon.moves.0.move", 0xCFED, [0x00], null);
        }
        [TestMethod]
        public async Task Red_Property_OK_Events()
        {
            ...
            var mapper = await GameHookClient.GetMapperAsync();
            mapper.AssertAreEqual("events.beatChampion", 0xD867, [0x00], false);
            mapper.AssertAreEqual("events.trashCanPuzzle", 0xD773, [0x03], true);
            mapper.AssertAreEqual("events.overworldFlags.countPlayTime", 0xD731, [0x00], false);
        }
        [TestMethod]
        public async Task Red_Property_OK_Overworld()
        {
            ...
            mapper.AssertAreEqual("overworld.encounters.common.2.level", 0xD88C, [0x1A], 26);
            mapper.AssertAreEqual("overworld.encounters.common.2.species", 0xD88D, [0x05], "Spearow");
            mapper.AssertAreEqual("overworld.encounterRate", 0xD887, [0x00], 0);
            mapper.AssertAreEqual("overworld.mapData.palette", 0xD35D, [0x00], 0);
        }
        [TestMethod]
        public async Task Red_Property_OK_Screen()
        {
            ...
            mapper.AssertAreEqual("screen.menu.currentItem", 0xCC26, [0x00], 0);
            mapper.AssertAreEqual("screen.tiles.column1.tile7", 0x9CCD, [0x11], 17);
        }
    }
}
